...
lazy val kernelLaws = crossProject(JSPlatform, JVMPlatform).crossType(CrossType.Pure)
  .in(file("kernel-laws"))
...
lazy val free = crossProject(JSPlatform, JVMPlatform).crossType(CrossType.Pure)
...
lazy val testkit = crossProject(JSPlatform, JVMPlatform).crossType(CrossType.Pure)
...
lazy val alleycatsCore = crossProject(JSPlatform, JVMPlatform).crossType(CrossType.Pure)
...
lazy val alleycatsLaws = crossProject(JSPlatform, JVMPlatform).crossType(CrossType.Pure)
...
lazy val alleycatsTests = crossProject(JSPlatform, JVMPlatform).crossType(CrossType.Pure)
